...
export const houseContent = {
  it: {
    pageTitle: "Storia | Pasta Lab & Smoked Flavors",
    seo: {
      description:
        "Scopri la storia di Pasta Lab & Smoked Flavors: Matteo Valli, Liis Saar e Aleksander “Sass” Kõiv guidano un bistrò di pasta a Tallinn tra tecnica italiana e carattere baltico.",
    },
    hero: {
      eyebrow: "Storia",
      title: "Una piccola storia, costruita attorno alla pasta fresca.",
      subtitle:
    ...
    founders: {
      ...
      members: [
        ...
        {
          name: "Liis Saar",
          role: "Co-Founder & Direzione di sala",
          text:
    ...
    rituals: {
      eyebrow: "Rituali",
      title: "Piccoli gesti che rendono il locale riconoscibile",
      text:
    ...
    cta: {
      ...
      title: "Se la storia ti convince, il tavolo è il passo successivo.",
      text:
  ...
  en: {
    pageTitle: "Story | Pasta Lab & Smoked Flavors",
    seo: {
      description:
        "Meet the story behind Pasta Lab & Smoked Flavors: Matteo Valli, Liis Saar, and Aleksander “Sass” Kõiv shape a Tallinn pasta bistro with Italian craft and Baltic character.",
    },
    hero: {
      eyebrow: "Story",
      title: "A small story built around fresh pasta.",
      subtitle:
        "Pasta Lab & Smoked Flavors brings together Matteo Valli's pasta discipline, Liis Saar's room direction, and Aleksander “Sass” Kõiv's floor and pairing rhythm.",
    ...
    founders: {
      ...
      text:
        "Kitchen, floor, and room direction stay distinct but aligned. Each role carries its own responsibility, and together they define the rhythm of the place.",
      members: [
        {
          name: "Matteo Valli",
          role: "Chef & Co-Founder",
        ...
        {
          name: "Liis Saar",
          role: "Co-Founder & Room Direction",
          text:
            "Shapes the Baltic side of the room: materials, pacing, welcome, and the feeling of a space that is warm but controlled.",
        },
        {
          name: 'Aleksander “Sass” Kõiv',
          role: "Pairings & Floor",
    ...
    rituals: {
      eyebrow: "Rituals",
      title: "Small gestures that make the room recognizable",
      text:
      ...
      items: [
        {
          ...
          text:
            "A first gesture that immediately sets the language of the room.",
        },
        {
    ...
    cta: {
      eyebrow: "Next step",
      title: "If the story feels right, the table is the next move.",
      text:
  ...
  et: {
    pageTitle: "Lugu | Pasta Lab & Smoked Flavors",
    seo: {
      description:
        "Tutvu Pasta Lab & Smoked Flavors looga: Matteo Valli, Liis Saar ja Aleksander “Sass” Kõiv kujundavad Tallinna pasta-bistroo, kus Itaalia käsitöö kohtub Balti karakteriga.",
    },
    hero: {
      eyebrow: "Lugu",
      title: "Väike lugu, mis on ehitatud värske pasta ümber.",
      subtitle:
    ...
    founders: {
      ...
      members: [
        ...
        {
          name: "Liis Saar",
          role: "Co-Founder & Saali juhtimine",
          text:
    ...
    rituals: {
      eyebrow: "Rituaalid",
      title: "Väikesed žestid, mis teevad ruumi äratuntavaks",
      text:
    ...
    cta: {
      ...
      title: "Kui lugu tundub õige, on laud järgmine samm.",
      text:
  ...
  ru: {
    pageTitle: "История | Pasta Lab & Smoked Flavors",
    seo: {
      description:
        "Познакомьтесь с историей Pasta Lab & Smoked Flavors: Matteo Valli, Liis Saar и Aleksander “Sass” Kõiv формируют таллиннское паста-бистро, где итальянское ремесло встречается с балтийским характером.",
    },
    hero: {
      eyebrow: "История",
      title: "Небольшая история, построенная вокруг свежей пасты.",
      subtitle:
        "Pasta Lab & Smoked Flavors соединяет паста-дисциплину Matteo Valli, руководство залом Liis Saar и ритм зала и pairing-ов Aleksander “Sass” Kõiv.",
    ...
    founders: {
      ...
      text:
        "Кухня, зал и руководство залом остаются разными, но движутся в одном ритме. У каждой роли своя задача, и вместе они формируют характер места.",
      members: [
        {
          name: "Matteo Valli",
          role: "Chef & Co-Founder",
        ...
        {
          name: "Liis Saar",
          role: "Сооснователь и руководство залом",
          text:
            "Формирует балтийскую сторону зала: материалы, темп, приём гостей и ощущение тёплого, но собранного пространства.",
        },
        {
          name: 'Aleksander “Sass” Kõiv',
          role: "Pairings & Floor",
    ...
    rituals: {
      eyebrow: "Ритуалы",
      title: "Маленькие жесты, по которым узнаётся зал",
      text:
      ...
      items: [
        {
          ...
          text:
            "Первый жест, который сразу задаёт язык зала.",
        },
        {
    ...
    cta: {
      ...
      title: "Если история кажется правильной, следующий шаг — стол.",
      text:
